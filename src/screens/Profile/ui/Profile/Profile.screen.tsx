  ...
  return (
    <SafeAreaView style={{ rowGap: 20 }}>
      ...
      <ScrollView bounces={false} contentContainerStyle={{
        ...
        <Link index={0} icon={<Ionicons name="stats-chart" size={24} color="#fff" />} title="Statistic" navigateTo="main" />
        <Link index={1} icon={<MaterialIcons name="groups" size={24} color="#fff"  />} title="Friends" navigateTo="main" />
        <Link index={2} icon={<Ionicons name="settings" size={24} color="#fff" />} title="Settings" navigateTo="main" />
      </ScrollView>
    </SafeAreaView>
  );
}
